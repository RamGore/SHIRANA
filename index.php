		...
		<div class="row">
			<div class="col-md-12">
				...
				<div id="grid" class="masonry-gallery grid-four-item clearfix">
					...
					<!-- Masonry Item -->
					<div class="isotope-item charity education">
					...
					<!-- Masonry Item -->
					<div class="isotope-item new education children">
						<div class="gallery-thumb">
					...
					<!-- Masonry Item -->
					<div class="isotope-item education children">
						<div class="gallery-thumb">
					...
					<!-- Masonry Item -->
					<div class="isotope-item new charity">
						<div class="gallery-thumb">
